package
{
   ...
   public class _player_FlexInit
   {
      ...
      public static function init(param1:IFlexModuleFactory) : void
      {
         ...
         var styleNames:Array = ["contentBackgroundAlpha","fontAntiAliasType","errorColor","direction","locale","kerning","backgroundDisabledColor","modalTransparencyColor","textRollOverColor","textIndent","themeColor","modalTransparency","textDecoration","headerColors","fontThickness","textAlign","fontFamily","textSelectedColor","labelWidth","fontGridFitType","letterSpacing","chromeColor","rollOverColor","fontStyle","dropShadowColor","fontSize","accentColor","selectionColor","disabledColor","fontWeight","modalTransparencyBlur","focusColor","leading","color","symbolColor","barColor","fontSharpness","modalTransparencyDuration","layoutDirection","footerColors","contentBackgroundColor"];
         var i:int = 0;
