package fl.transitions
{
   ...
   public class Fly extends Transition
   {
      ...
      public function Fly(param1:MovieClip, param2:Object, param3:TransitionManager)
      {
         ...
         var _loc4_:Stage;
         var _loc5_:String = (_loc4_ = param1.stage).scaleMode;
         _loc4_.scaleMode = StageScaleMode.SHOW_ALL;
         var _loc6_:Object;
         (_loc6_ = this._stagePoints = {})[1] = new Point(0,0);
         ...
         _loc6_[1].x -= _loc8_.right;
         _loc6_[1].y -= _loc8_.bottom;
         _loc6_[2].x = this.manager.contentAppearance.x;
         _loc6_[2].y -= _loc8_.bottom;
         _loc6_[3].x -= _loc8_.left;
         _loc6_[3].y -= _loc8_.bottom;
         _loc6_[4].x -= _loc8_.right;
         _loc6_[4].y = this.manager.contentAppearance.y;
         _loc6_[5].x -= (_loc8_.right + _loc8_.left) / 2;
         _loc6_[5].y -= (_loc8_.bottom + _loc8_.top) / 2;
         _loc6_[6].x -= _loc8_.left;
         _loc6_[6].y = this.manager.contentAppearance.y;
         _loc6_[7].x -= _loc8_.right;
         _loc6_[7].y -= _loc8_.top;
         _loc6_[8].x = this.manager.contentAppearance.x;
         _loc6_[8].y -= _loc8_.top;
         _loc6_[9].x -= _loc8_.left;
         _loc6_[9].y -= _loc8_.top;
