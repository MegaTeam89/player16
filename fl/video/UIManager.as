package fl.video
{
   ...
   public class UIManager
   {
      ...
      public function UIManager(param1:FLVPlayback)
      {
         ...
         _skin = null;
         _skinAutoHide = false;
         cacheSkinAutoHide = flvplayback_internal::_skinAutoHide;
         _skinFadingMaxTime = flvplayback_internal::SKIN_FADING_MAX_TIME_DEFAULT;
         _skinAutoHideMotionTimeout = flvplayback_internal::SKIN_AUTO_HIDE_MOTION_TIMEOUT_DEFAULT;
         _skinReady = true;
         __visible = false;
         ...
         _lastScrubPos = 0;
         _lastVolumePos = 0;
         cachedSoundLevel = flvplayback_internal::_vc.volume;
         _isMuted = false;
         controls = new Array();
         customClips = null;
         ...
         borderAlpha = 0.85;
         borderColor = 4697035;
         borderColorTransform = new ColorTransform(0,0,0,0,71,171,203,255 * flvplayback_internal::borderAlpha);
         ...
         _skinAutoHideTimer = new Timer(flvplayback_internal::SKIN_AUTO_HIDE_INTERVAL);
         flvplayback_internal::_skinAutoHideTimer.addEventListener(TimerEvent.TIMER,flvplayback_internal::skinAutoHideHitTest);
         _skinFadingTimer = new Timer(flvplayback_internal::SKIN_FADING_INTERVAL);
         ...
         if(flvplayback_internal::_vc.stage != null)
         {
            try
            {
               _fullScreen = flvplayback_internal::_vc.stage.displayState == StageDisplayState.FULL_SCREEN;
      ...
      flvplayback_internal function finishLoad(param1:Event) : void
      {
         ...
         try
         {
            ...
            _skinReady = true;
            flvplayback_internal::_vc.skinLoaded();
            cachedActivePlayerIndex = flvplayback_internal::_vc.activeVideoPlayerIndex;
            ...
            while(j < NUM_CONTROLS)
            {
               if(flvplayback_internal::controls[j] != undefined)
               {
                  ...
                  if(j < NUM_BUTTONS)
                  {
                     skinButtonControl(flvplayback_internal::controls[j]);
                  }
               }
               j++;
            }
         ...
         if(flvplayback_internal::skin_mc != null)
         {
            ...
            while(i < NUM_CONTROLS)
            {
               if(flvplayback_internal::controls[i] != undefined)
               {
                  if(i < NUM_BUTTONS)
                  {
                     removeButtonListeners(flvplayback_internal::controls[i]);
                  }
      ...
      flvplayback_internal function setupButtonSkin(param1:int) : Sprite
      {
         ...
         _loc4_.state_mc[NORMAL_STATE] = setupButtonSkinState(_loc3_,flvplayback_internal::skinTemplate,_loc2_ + "NormalState");
         _loc4_.state_mc[NORMAL_STATE].visible = true;
         _loc4_.state_mc[OVER_STATE] = setupButtonSkinState(_loc3_,flvplayback_internal::skinTemplate,_loc2_ + "OverState",_loc4_.state_mc[NORMAL_STATE]);
         _loc4_.state_mc[DOWN_STATE] = setupButtonSkinState(_loc3_,flvplayback_internal::skinTemplate,_loc2_ + "DownState",_loc4_.state_mc[NORMAL_STATE]);
         _loc4_.disabled_mc = setupButtonSkinState(_loc3_,flvplayback_internal::skinTemplate,_loc2_ + "DisabledState",_loc4_.state_mc[NORMAL_STATE]);
         return _loc3_;
      }
      ...
      flvplayback_internal function dispatchMessage(param1:int) : void
      {
         ...
         {
            flvplayback_internal::_vc._scrubStart();
         }
         cachedActivePlayerIndex = flvplayback_internal::_vc.activeVideoPlayerIndex;
         flvplayback_internal::_vc.activeVideoPlayerIndex = flvplayback_internal::_vc.visibleVideoPlayerIndex;
         switch(index)
         {
            ...
            case MUTE_ON_BUTTON:
               if(!flvplayback_internal::_isMuted)
               {
                  ...
                  skinButtonControl(flvplayback_internal::controls[MUTE_OFF_BUTTON]);
                  setEnabledAndVisibleForState(MUTE_ON_BUTTON,VideoState.PLAYING);
                  skinButtonControl(flvplayback_internal::controls[MUTE_ON_BUTTON]);
               }
               break;
            ...
            case FULL_SCREEN_ON_BUTTON:
               if(!flvplayback_internal::_fullScreen && flvplayback_internal::_vc.stage != null)
               {
                  ...
                  skinButtonControl(flvplayback_internal::controls[FULL_SCREEN_OFF_BUTTON]);
                  setEnabledAndVisibleForState(FULL_SCREEN_ON_BUTTON,VideoState.PLAYING);
                  skinButtonControl(flvplayback_internal::controls[FULL_SCREEN_ON_BUTTON]);
               }
               break;
      ...
      flvplayback_internal function seekBarListener(param1:TimerEvent) : void
      {
         ...
         calcPercentageFromHandle(_loc3_);
      ...
      flvplayback_internal function doBufferingDelay(param1:TimerEvent) : void
      {
         ...
         {
            _bufferingOn = true;
            handleIVPEvent(new VideoEvent(VideoEvent.STATE_CHANGE,false,false,VideoState.BUFFERING,NaN,flvplayback_internal::_vc.visibleVideoPlayerIndex));
         }
         flvplayback_internal::_vc.activeVideoPlayerIndex = _loc2_;
      }
      ...
      flvplayback_internal function volumeBarListener(param1:TimerEvent) : void
      {
         ...
         calcPercentageFromHandle(_loc2_);
         ...
         if(_loc5_ || flvplayback_internal::_volumeBarScrubTolerance <= 0 || Math.abs(_loc4_ - flvplayback_internal::_lastVolumePos) > flvplayback_internal::_volumeBarScrubTolerance || _loc4_ < flvplayback_internal::_volumeBarScrubTolerance || _loc4_ > 100 - flvplayback_internal::_volumeBarScrubTolerance)
         {
            if(_loc4_ != flvplayback_internal::_lastVolumePos)
            {
               if(flvplayback_internal::_isMuted)
               {
                  cachedSoundLevel = _loc4_ / 100;
               }
               else
               {
                  flvplayback_internal::_vc.volume = _loc4_ / 100;
               }
               _lastVolumePos = _loc4_;
            }
         }
      }
      ...
      flvplayback_internal function resetPlayPause() : void
      {
         ...
         {
            removeButtonListeners(flvplayback_internal::controls[_loc1_]);
      ...
      public function setControl(param1:int, param2:Sprite) : void
      {
         ...
         if(flvplayback_internal::controls[index] != null)
         {
            ...
            {
               removeButtonListeners(flvplayback_internal::controls[index]);
            }
         ...
         if(index >= NUM_BUTTONS)
         {
            ...
            setEnabledAndVisibleForState(index,flvplayback_internal::_vc.state);
         }
         else
         {
            flvplayback_internal::controls[index] = ctrl;
      ...
      flvplayback_internal function addButtonControl(param1:Sprite) : void
      {
         ...
         _loc3_ = flvplayback_internal::_vc.activeVideoPlayerIndex;
         flvplayback_internal::_vc.activeVideoPlayerIndex = flvplayback_internal::_vc.visibleVideoPlayerIndex;
         _loc2_.state = NORMAL_STATE;
         setEnabledAndVisibleForState(_loc2_.index,flvplayback_internal::_vc.state);
      ...
      flvplayback_internal function positionHandle(param1:Sprite) : void
      {
         ...
         _loc4_ = ctrlDataDict[_loc3_];
         _loc6_ = (_loc5_ = !!isNaN(_loc2_.origWidth) ? Number(param1.width) : Number(_loc2_.origWidth)) - _loc4_.rightMargin - _loc4_.leftMargin;
         _loc3_.x = param1.x + _loc4_.leftMargin + _loc6_ * _loc2_.percentage / 100;
         _loc3_.y = param1.y + _loc4_.origY;
         if(_loc2_.fullness_mc != null)
         {
            positionBar(param1,"fullness",_loc2_.percentage);
         }
      }
      ...
      flvplayback_internal function exitFullScreenTakeOver() : void
      {
         ...
         try
         {
            ...
            cacheActiveIndex = flvplayback_internal::_vc.activeVideoPlayerIndex;
            i = 0;
            while(i < flvplayback_internal::_vc.videoPlayers.length)
            {
               vp = flvplayback_internal::_vc.videoPlayers[i] as VideoPlayer;
               if(vp != null)
               {
         ...
         {
            _skinAutoHide = flvplayback_internal::cacheSkinAutoHide;
            setupSkinAutoHide(false);
         }
      }
      ...
      flvplayback_internal function handleRelease(param1:int) : void
      {
         ...
         stopHandleDrag(flvplayback_internal::controls[param1]);
         flvplayback_internal::_vc.activeVideoPlayerIndex = _loc2_;
         if(param1 == SEEK_BAR)
         {
            flvplayback_internal::_vc._scrubFinish();
         }
      }
      ...
      flvplayback_internal function setTwoButtonHolderSkin(param1:int, param2:int, param3:String, param4:int, param5:String) : Sprite
      {
         ...
         (_loc6_ = setupButtonSkin(param2)).name = param3;
         _loc6_.visible = true;
         _loc7_.addChild(_loc6_);
         (_loc6_ = setupButtonSkin(param4)).name = param5;
            ...
            else if(flvplayback_internal::_vc.stage != null)
            {
               ...
               if(flvplayback_internal::_fullScreen && flvplayback_internal::_fullScreenTakeOver && e != null)
               {
                  ...
                  else
                  {
                     ...
                     _skinAutoHideMouseX = flvplayback_internal::_vc.stage.mouseX;
                     _skinAutoHideMouseY = flvplayback_internal::_vc.stage.mouseY;
                  }
               }
      ...
      flvplayback_internal function layoutControl(param1:DisplayObject) : void
      {
         ...
         _loc3_ = calcLayoutControl(param1);
         param1.x = _loc3_.x;
         param1.y = _loc3_.y;
         ...
         switch(_loc2_.index)
         {
            ...
            case VOLUME_BAR:
               if(_loc2_.hit_mc != null && _loc2_.hit_mc.parent == flvplayback_internal::skin_mc)
               {
                  ...
                  _loc5_ = calcLayoutControl(_loc4_);
                  _loc4_.x = _loc5_.x;
                  _loc4_.y = _loc5_.y;
               ...
               if(_loc2_.progress_mc != null)
               {
                  ...
                  {
                     _progressPercent = !!flvplayback_internal::_vc.isRTMP ? Number(100) : Number(0);
                  }
                  positionBar(Sprite(param1),"progress",flvplayback_internal::_progressPercent);
               }
      ...
      public function set skin(param1:String) : void
      {
         ...
         else
         {
            ...
            removeSkin();
            _skin = String(param1);
            _skinReady = flvplayback_internal::_skin == "";
      ...
      flvplayback_internal function setSkin(param1:int, param2:DisplayObject) : void
      {
         ...
         else
         {
            ...
            {
               case PLAY_PAUSE_BUTTON:
                  _loc3_ = setTwoButtonHolderSkin(param1,PLAY_BUTTON,"play_mc",PAUSE_BUTTON,"pause_mc");
                  _loc4_ = ctrlDataDict[_loc3_];
                  break;
               case FULL_SCREEN_BUTTON:
                  _loc3_ = setTwoButtonHolderSkin(param1,FULL_SCREEN_ON_BUTTON,"on_mc",FULL_SCREEN_OFF_BUTTON,"off_mc");
                  _loc4_ = ctrlDataDict[_loc3_];
                  break;
               case MUTE_BUTTON:
                  _loc3_ = setTwoButtonHolderSkin(param1,MUTE_ON_BUTTON,"on_mc",MUTE_OFF_BUTTON,"off_mc");
                  _loc4_ = ctrlDataDict[_loc3_];
                  break;
               case SEEK_BAR:
               case VOLUME_BAR:
                  _loc5_ = flvplayback_internal::skinClassPrefixes[param1];
                  _loc3_ = Sprite(createSkin(flvplayback_internal::skinTemplate,_loc5_));
                  if(_loc3_ != null)
                  {
                     flvplayback_internal::skin_mc.addChild(_loc3_);
                     _loc4_ = new ControlData(this,_loc3_,null,param1);
                     ctrlDataDict[_loc3_] = _loc4_;
                     _loc4_.progress_mc = setupBarSkinPart(_loc3_,param2,flvplayback_internal::skinTemplate,_loc5_ + "Progress","progress_mc");
                     _loc4_.fullness_mc = setupBarSkinPart(_loc3_,param2,flvplayback_internal::skinTemplate,_loc5_ + "Fullness","fullness_mc");
                     _loc4_.hit_mc = Sprite(setupBarSkinPart(_loc3_,param2,flvplayback_internal::skinTemplate,_loc5_ + "Hit","hit_mc"));
                     _loc4_.handle_mc = Sprite(setupBarSkinPart(_loc3_,param2,flvplayback_internal::skinTemplate,_loc5_ + "Handle","handle_mc",true));
               ...
               case BUFFERING_BAR:
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     _loc4_ = new ControlData(this,_loc3_,null,param1);
                     ctrlDataDict[_loc3_] = _loc4_;
                     _loc4_.fill_mc = setupBarSkinPart(_loc3_,param2,flvplayback_internal::skinTemplate,_loc5_ + "Fill","fill_mc");
                     _loc3_.width = param2.width;
                     _loc3_.height = param2.height;
                  }
            }
      ...
      flvplayback_internal function handleLoad(param1:Event) : void
      {
         ...
         try
         {
            ...
            if(e != null)
            {
               skinTemplate = Sprite(flvplayback_internal::skinLoader.content);
            }
            layout_mc = flvplayback_internal::skinTemplate;
      ...
      flvplayback_internal function finishAddBufferingBar(param1:Event = null) : void
      {
         ...
         calcBarMargins(_loc2_,"fill",true);
         fixUpBar(_loc2_,"fill",_loc2_,"fill_mc");
         positionMaskedFill(_loc2_,100);
      }
      ...
      {
         _skinReady = true;
         flvplayback_internal::_vc.skinError(param1.toString());
      }
      ...
      flvplayback_internal function skinButtonControl(param1:Object) : void
      {
         ...
         {
            ctrlData.state_mc[NORMAL_STATE] = setupButtonSkinState(ctrl,ctrl,flvplayback_internal::buttonSkinLinkageIDs[NORMAL_STATE],null);
         }
         if(ctrlData.enabled && flvplayback_internal::_controlsEnabled)
         {
            if(ctrlData.state_mc[ctrlData.state] == undefined)
            {
               ctrlData.state_mc[ctrlData.state] = setupButtonSkinState(ctrl,ctrl,flvplayback_internal::buttonSkinLinkageIDs[ctrlData.state],ctrlData.state_mc[NORMAL_STATE]);
            }
      ...
      public function set controlsEnabled(param1:Boolean) : void
      {
         ...
         {
            skinButtonControl(flvplayback_internal::controls[_loc2_]);
            _loc2_++;
         }
      }
         ...
         if(!flvplayback_internal::_fullScreen && flvplayback_internal::_vc.stage != null)
         {
            if(flvplayback_internal::_fullScreenTakeOver)
            {
               try
               {
                  ...
                  effectiveMinWidth = flvplayback_internal::fullScreenSourceRectMinWidth;
                  effectiveMinHeight = flvplayback_internal::fullScreenSourceRectMinHeight;
      ...
      flvplayback_internal function finishAddBarControl(param1:Object) : void
      {
         ...
         if(ctrlData.progress_mc != null)
         {
            ...
            positionBar(ctrl,"progress",flvplayback_internal::_progressPercent);
         }
      ...
      flvplayback_internal function startHandleDrag(param1:Sprite) : void
      {
         ...
         theWidth = !!isNaN(ctrlData.origWidth) ? Number(ctrl.width) : Number(ctrlData.origWidth);
      ...
      flvplayback_internal function handleIVPEvent(param1:IVPEvent) : void
      {
         ...
         switch(param1.type)
         {
            case VideoEvent.STATE_CHANGE:
               ...
               {
                  _progressPercent = !!flvplayback_internal::_vc.getVideoPlayer(param1.vp).isRTMP ? Number(100) : Number(0);
                  _loc3_ = SEEK_BAR;
                  while(_loc3_ <= VOLUME_BAR)
                  {
                     ...
                     if(flvplayback_internal::controls[_loc3_] != null)
                     {
                        ...
                        {
                           positionBar(_loc5_,"progress",flvplayback_internal::_progressPercent);
                        }
                     }
                     _loc3_++;
                  }
               ...
               while(_loc3_ < NUM_CONTROLS)
               {
                  ...
                  {
                     setEnabledAndVisibleForState(_loc3_,_loc4_.state);
                     if(_loc3_ < NUM_BUTTONS)
                     {
                        skinButtonControl(flvplayback_internal::controls[_loc3_]);
                     }
                  }
                  _loc3_++;
               }
            ...
            case MetadataEvent.METADATA_RECEIVED:
               ...
               while(_loc3_ < NUM_CONTROLS)
               {
                  if(flvplayback_internal::controls[_loc3_] != undefined)
                  {
                     setEnabledAndVisibleForState(_loc3_,flvplayback_internal::_vc.state);
                     if(_loc3_ < NUM_BUTTONS)
                     {
                        skinButtonControl(flvplayback_internal::controls[_loc3_]);
                     }
            ...
            case VideoEvent.PLAYHEAD_UPDATE:
               if(flvplayback_internal::controls[SEEK_BAR] != undefined && !flvplayback_internal::_vc.isLive && !isNaN(flvplayback_internal::_vc.totalTime) && flvplayback_internal::_vc.getVideoPlayer(flvplayback_internal::_vc.visibleVideoPlayerIndex).state != VideoState.SEEKING)
               {
                  ...
                  positionHandle(_loc5_);
               }
               break;
            case VideoProgressEvent.PROGRESS:
               _loc7_ = VideoProgressEvent(param1);
               _progressPercent = _loc7_.bytesTotal <= 0 ? Number(100) : Number(_loc7_.bytesLoaded / _loc7_.bytesTotal * 100);
               _loc9_ = (_loc8_ = flvplayback_internal::_vc.videoPlayerStates[param1.vp]).minProgressPercent;
               if(!isNaN(_loc9_) && _loc9_ > flvplayback_internal::_progressPercent)
               {
                  _progressPercent = _loc9_;
               }
      ...
      flvplayback_internal function layoutSkin() : void
      {
         ...
         videoLeft = flvplayback_internal::_vc.x - flvplayback_internal::_vc.registrationX;
         videoRight = flvplayback_internal::videoLeft + flvplayback_internal::_vc.width;
         videoTop = flvplayback_internal::_vc.y - flvplayback_internal::_vc.registrationY;
         videoBottom = flvplayback_internal::videoTop + flvplayback_internal::_vc.height;
         if(flvplayback_internal::_fullScreen && flvplayback_internal::_fullScreenTakeOver && flvplayback_internal::border_mc != null)
         {
            borderRect = calcLayoutControl(flvplayback_internal::border_mc);
            forceSkinAutoHide = false;
            if(borderRect.width > 0 && borderRect.height > 0)
            {
               if(borderRect.x < 0)
               {
                  placeholderLeft += flvplayback_internal::videoLeft - borderRect.x;
                  forceSkinAutoHide = true;
               }
               if(borderRect.x + borderRect.width > flvplayback_internal::_vc.registrationWidth)
               {
                  placeholderRight += borderRect.x + borderRect.width - flvplayback_internal::videoRight;
                  forceSkinAutoHide = true;
               }
               if(borderRect.y < 0)
               {
                  placeholderTop += flvplayback_internal::videoTop - borderRect.y;
                  forceSkinAutoHide = true;
               }
               if(borderRect.y + borderRect.height > flvplayback_internal::_vc.registrationHeight)
               {
                  placeholderBottom += borderRect.y + borderRect.height - flvplayback_internal::videoBottom;
                  forceSkinAutoHide = true;
               }
         ...
         try
         {
            ...
            {
               minWidth = flvplayback_internal::layout_mc["minWidth"];
               ...
               if(minWidth > 0 && minWidth > vidWidth)
               {
                  ...
                  videoRight = minWidth + flvplayback_internal::videoLeft;
               }
            }
         }
         catch(re1:ReferenceError)
         ...
         try
         {
            ...
            {
               minHeight = flvplayback_internal::layout_mc["minHeight"];
               ...
               if(minHeight > 0 && minHeight > vidHeight)
               {
                  ...
                  videoBottom = minHeight + flvplayback_internal::videoTop;
               }
            }
         }
         catch(re2:ReferenceError)
         ...
         while(i < NUM_CONTROLS)
         {
            layoutControl(flvplayback_internal::controls[i]);
            i++;
         }
      }
      ...
      flvplayback_internal function enterFullScreenTakeOver() : void
      {
         ...
         try
         {
            ...
            cacheFLVPlaybackParent = flvplayback_internal::_vc.parent;
            cacheFLVPlaybackIndex = flvplayback_internal::_vc.parent.getChildIndex(flvplayback_internal::_vc);
            ...
            if(!flvplayback_internal::_fullScreenAccel)
            {
               cacheStageAlign = flvplayback_internal::_vc.stage.align;
               cacheStageScaleMode = flvplayback_internal::_vc.stage.scaleMode;
