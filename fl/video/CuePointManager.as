package fl.video
{
   ...
   public class CuePointManager
   {
      ...
      public function CuePointManager(param1:FLVPlayback, param2:uint)
      {
         ...
         _id = param2;
         reset();
         _asCuePointTolerance = _owner.getVideoPlayer(flvplayback_internal::_id).playheadUpdateInterval / 2000;
         _linearSearchTolerance = flvplayback_internal::DEFAULT_LINEAR_SEARCH_TOLERANCE;
      }
      ...
      flvplayback_internal function getCuePoint(param1:Array, param2:Boolean, param3:*) : Object
      {
         ...
         if((_loc5_ = getCuePointIndex(param1,param2,_loc4_.time,_loc4_.name)) < 0)
         {
            return null;
         }
      ...
      public function resetASCuePointIndex(param1:Number) : void
      {
         ...
         _loc2_ = getCuePointIndex(flvplayback_internal::asCuePoints,true,param1);
         _asCuePointIndex = flvplayback_internal::asCuePoints[_loc2_].time < param1 ? int(_loc2_ + 1) : int(_loc2_);
      }
      ...
      public function processFLVCuePoints(param1:Array) : void
      {
         ...
         while((_loc4_ = flvplayback_internal::flvCuePoints[_loc7_++]) != undefined)
         {
            ...
            if(flvplayback_internal::_disabledCuePointsByNameOnly[_loc4_.name] != undefined || _loc6_ < _loc5_.length && cuePointCompare(_loc5_[_loc6_].time,_loc5_[_loc6_].name,_loc4_) == 0)
            {
            ...
            {
               _loc2_ = getCuePointIndex(flvplayback_internal::allCuePoints,true,_loc4_.time);
               _loc2_ = flvplayback_internal::allCuePoints[_loc2_].time > _loc4_.time ? 0 : int(_loc2_ + 1);
      ...
      public function addASCuePoint(param1:*, param2:String = null, param3:Object = null) : Object
      {
         ...
         {
            _loc7_ = getCuePointIndex(flvplayback_internal::asCuePoints,true,_loc4_.time);
            _loc7_ = flvplayback_internal::asCuePoints[_loc7_].time > _loc4_.time ? 0 : int(_loc7_ + 1);
         ...
         {
            _loc10_ = getCuePointIndex(flvplayback_internal::allCuePoints,true,_loc4_.time);
            _loc10_ = flvplayback_internal::allCuePoints[_loc10_].time > _loc4_.time ? 0 : int(_loc10_ + 1);
         ...
         (_loc9_ = deepCopyObject(flvplayback_internal::asCuePoints[_loc7_])).array = flvplayback_internal::asCuePoints;
         _loc9_.index = _loc7_;
         return _loc9_;
      }
      ...
      public function removeCuePoints(param1:Array, param2:Object) : Number
      {
         ...
         var _loc5_:int = 0;
         _loc5_ = 0;
         _loc3_ = getCuePointIndex(param1,true,-1,param2.name);
         while(_loc3_ >= 0)
         {
            ...
            _loc3_--;
            _loc5_++;
            _loc3_ = getNextCuePointIndexWithName(_loc4_.name,param1,_loc3_);
         }
         return _loc5_;
      }
      ...
      public function setFLVCuePointEnabled(param1:Boolean, param2:*) : int
      {
         ...
         if(_loc4_)
         {
            ...
            {
               _loc7_ = getCuePointIndex(flvplayback_internal::flvCuePoints,true,-1,_loc3_.name);
               while(_loc7_ >= 0)
               {
                  _loc9_ = flvplayback_internal::flvCuePoints[_loc7_];
                  if((_loc8_ = getCuePointIndex(flvplayback_internal::_disabledCuePoints,true,_loc9_.time)) < 0 || flvplayback_internal::_disabledCuePoints[_loc8_].time != _loc9_.time)
                  {
                     _disabledCuePoints = insertCuePoint(_loc8_,flvplayback_internal::_disabledCuePoints,{
                        "name":_loc9_.name,
                        "time":_loc9_.time
                     });
                     _loc6_ += 1;
                  }
                  _loc7_ = getNextCuePointIndexWithName(_loc9_.name,flvplayback_internal::flvCuePoints,_loc7_);
               }
            }
            return _loc6_;
         }
         if((_loc7_ = getCuePointIndex(flvplayback_internal::_disabledCuePoints,false,_loc3_.time,_loc3_.name)) < 0)
         {
            if(param1)
            {
               if(!flvplayback_internal::_metadataLoaded)
               {
                  if((_loc7_ = getCuePointIndex(flvplayback_internal::_disabledCuePoints,false,_loc3_.time)) < 0)
                  {
                     _loc8_ = getCuePointIndex(flvplayback_internal::_disabledCuePointsByNameOnly[_loc3_.name],true,_loc3_.time);
                     if(cuePointCompare(_loc3_.time,null,flvplayback_internal::_disabledCuePointsByNameOnly[_loc3_.name]) != 0)
                     {
            ...
            if(flvplayback_internal::_metadataLoaded)
            {
               if((_loc7_ = getCuePointIndex(flvplayback_internal::flvCuePoints,false,_loc3_.time,_loc3_.name)) < 0)
               {
                  return 0;
               }
               if(_loc5_)
            ...
            _loc8_ = getCuePointIndex(flvplayback_internal::_disabledCuePoints,true,_loc3_.time);
            _disabledCuePoints = insertCuePoint(_loc8_,flvplayback_internal::_disabledCuePoints,_loc3_);
            _loc6_ = 1;
      ...
      public function isFLVCuePointEnabled(param1:*) : Boolean
      {
         ...
         if(_loc3_)
         {
            if((_loc5_ = getCuePointIndex(flvplayback_internal::flvCuePoints,true,-1,_loc2_.name)) < 0)
            {
               return true;
            }
            while(_loc5_ >= 0)
            {
               if(getCuePointIndex(flvplayback_internal::_disabledCuePoints,false,flvplayback_internal::flvCuePoints[_loc5_].time,flvplayback_internal::flvCuePoints[_loc5_].name) < 0)
               {
                  return true;
               }
               _loc5_ = getNextCuePointIndexWithName(_loc2_.name,flvplayback_internal::flvCuePoints,_loc5_);
            }
            return false;
         }
         return getCuePointIndex(flvplayback_internal::_disabledCuePoints,false,_loc2_.time,_loc2_.name) < 0;
      }
      ...
      public function removeASCuePoint(param1:*) : Object
      {
         ...
         _loc3_ = getCuePointIndex(flvplayback_internal::asCuePoints,false,_loc2_.time,_loc2_.name);
         if(_loc3_ < 0)
         {
            return null;
         }
         ...
         _loc3_ = getCuePointIndex(flvplayback_internal::allCuePoints,false,_loc2_.time,_loc2_.name);
         if(_loc3_ > 0)
         {
      ...
      public function dispatchASCuePoints() : void
      {
         ...
         if(_owner.getVideoPlayer(flvplayback_internal::_id).stateResponsive && flvplayback_internal::asCuePoints != null)
         {
            ...
            {
               _owner.dispatchEvent(new MetadataEvent(MetadataEvent.CUE_POINT,false,false,deepCopyObject(flvplayback_internal::asCuePoints[_asCuePointIndex++]),flvplayback_internal::_id));
            }
         }
      }
      ...
      flvplayback_internal function getNextCuePointWithName(param1:Object) : Object
      {
         ...
         _loc2_ = getNextCuePointIndexWithName(param1.name,param1.array,param1.index);
         if(_loc2_ < 0)
         {
            return null;
         }
         _loc3_ = deepCopyObject(param1.array[_loc2_]);
      ...
      flvplayback_internal function getCuePointIndex(param1:Array, param2:Boolean, param3:Number = NaN, param4:String = null, param5:int = -1, param6:int = -1) : int
      {
         ...
         if(!_loc8_ && (param2 || _loc7_))
         {
            ...
            {
               _loc12_ = getCuePointIndex(param1,param2,param3);
            }
            _loc13_ = _loc12_;
         ...
         {
            return getCuePointIndex(param1,param2,param3,param4,param5,_loc10_);
         }
         if(_loc9_ > 0)
         {
            return getCuePointIndex(param1,param2,param3,param4,_loc11_ + 1,_loc10_ - 1 + param6 % 2);
         }
         return _loc11_;
      }
   }
