package Singularity.Geom
{
   public class FastCubicSpline
   {
      ...
      public function eval(param1:Number) : Number
      {
         ...
         _loc4_ = (this.__y[_loc2_ + 1] - this.__y[_loc2_]) * this.__hInv[_loc2_] - this.__h[_loc2_] * (this.__z[_loc2_ + 1] + 2 * this.__z[_loc2_]) * 0.1666666666666667;
         _loc5_ = 0.5 * this.__z[_loc2_] + this.__delta * (this.__z[_loc2_ + 1] - this.__z[_loc2_]) * 0.1666666666666667 * this.__hInv[_loc2_];
         _loc6_ = _loc4_ + this.__delta * _loc5_;
         return Number(this.__y[_loc2_] + this.__delta * _loc6_);
      }
