package Singularity.Geom
{
   ...
   public class BezierSpline extends Composite
   {
      ...
      {
         var _loc4_:Object;
         (_loc4_ = this.__knots[param1]).X = param2;
         _loc4_.Y = param3;
         __invalidate = true;
      }
      ...
      public function insertControlPoint(param1:uint, param2:Number, param3:Number) : void
      {
         ...
         if(!isNaN(param2) && !isNaN(param3))
         {
            ...
            if(this.__index > 0)
            {
               (_loc4_ = new FastBezier()).subdivisions = this.__quality;
      ...
      override public function arcLength() : Number
      {
         ...
         {
            this.__index = _loc3_;
            _loc1_ += 0.5 * __integral.eval(this.__integrand,0,1,5);
            _loc3_++;
         }
         __arcLength = _loc1_;
         return _loc1_;
      ...
      override public function arcLengthAt(param1:Number) : Number
      {
         ...
         var _loc4_:Number = (_loc4_ = param1 < 0 ? Number(0) : Number(param1)) > 1 ? Number(1) : Number(_loc4_);
         var _loc5_:Number;
         var _loc6_:Number = (_loc5_ = _loc3_ - 1) * _loc4_;
         ...
         while(_loc10_ < _loc8_)
         {
            ...
            _loc2_ += 0.5 * __integral.eval(this.__integrand,0,1,5);
            _loc10_++;
         }
         if(_loc9_ != 0)
         {
            this.__index = _loc8_;
            _loc2_ += 0.5 * __integral.eval(this.__integrand,0,_loc9_,5);
         }
         return _loc2_;
      }
      ...
      public function __assignControlPoints() : void
      {
         ...
         while(_loc2_ < this.__bezier.length)
         {
            ...
            (_loc4_ = this.__bezier[_loc2_]).moveControlPoint(0,_loc3_.P0X,_loc3_.P0Y);
