package Singularity.Numeric
{
   ...
   public class Gauss extends EventDispatcher
   {
      ...
      public function eval(param1:Function, param2:Number, param3:Number, param4:uint) : Number
      {
         ...
         var _loc6_:uint = (_loc5_ = Math.min(_loc5_,MAX_POINTS)) == 2 ? uint(0) : uint(_loc5_ * (_loc5_ - 1) / 2 - 1);
         var _loc7_:Number = 0;
         if(param2 == -1 && param3 == 1)
         {
            ...
            while(_loc8_ < _loc5_)
            {
               _loc7_ += param1(this.__abscissa[_loc6_ + _loc8_]) * this.__weight[_loc6_ + _loc8_];
               _loc8_++;
            }
            return _loc7_;
         }
         ...
         while(_loc8_ < _loc5_)
         {
            _loc7_ += param1(_loc10_ + _loc9_ * this.__abscissa[_loc6_ + _loc8_]) * this.__weight[_loc6_ + _loc8_];
            _loc8_++;
         }
