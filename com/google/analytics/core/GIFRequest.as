package com.google.analytics.core
{
   ...
   public class GIFRequest
   {
      ...
      public function onIOError(param1:IOErrorEvent) : void
      {
         ...
         var _loc3_:String = "Gif Request failed";
         if(_debug.GIFRequests)
         {
            ...
            {
               _loc3_ += " \"" + _loc2_ + "\" does not exists or is unreachable";
            }
            _debug.failure(_loc3_);
         }
         else
         {
            _debug.warning(_loc3_);
         }
      ...
      private function _debugSend(param1:URLRequest) : void
      {
         ...
         switch(_debug.mode)
         {
            ...
            case VisualDebugMode.advanced:
               ...
               _loc2_ = "Send Gif Request:\n" + _loc3_ + " ?";
               break;
            case VisualDebugMode.basic:
            default:
               _loc2_ = "Send " + _config.serverMode.toString() + " Gif Request ?";
         }
      ...
      public function onComplete(param1:Event) : void
      {
         ...
         var _loc3_:String = "Gif Request sent";
