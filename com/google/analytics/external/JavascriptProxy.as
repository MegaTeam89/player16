package com.google.analytics.external
{
   ...
   public class JavascriptProxy
   {
      ...
      {
         return ExternalInterface.call(param1 + ".valueOf");
      }
      
      public function hasProperty(param1:String) : Boolean
      {
         return ExternalInterface.call(hasProperty_js,param1);
      }
      
      public function setProperty(param1:String, param2:*) : void
      {
         ExternalInterface.call(setProperty_js,param1,param2);
      }
      ...
      {
         return ExternalInterface.call(param1 + ".toString");
      }
      
      public function setPropertyByReference(param1:String, param2:String) : void
      {
         ExternalInterface.call(setPropertyRef_js,param1,param2);
      }
