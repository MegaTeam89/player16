package com.google.ads.instream.wrappers
{
   ...
   class AdSizeChangedEventWrapper extends AdSizeChangedEvent
   {
      ...
      function AdSizeChangedEventWrapper(param1:Object, param2:Object = null)
      {
         remoteMethodResultsStore = new Dictionary();
         this.remoteInstance = param1;
         this.localInstance = param2;
         super(Wrappers.remoteToLocal(remoteMethodResultsStore,param1.ad,localInstance) as Ad,param1.type,param1.state,param1.width,param1.height);
      }
