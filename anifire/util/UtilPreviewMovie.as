package anifire.util
{
   ...
   public class UtilPreviewMovie
   {
      ...
      public static function serializeSingleImageData(param1:String, param2:Object) : String
      {
         ...
         {
            _loc11_ = param2 as String;
            _loc3_ = _loc3_ + "<item type=\"" + ITEM_TYPE_STRING + "\" id=\"" + xmlEscape(param1) + "\">" + xmlEscape(_loc11_) + "</item>";
         }
         else if(param2 is Object)
         {
            ...
            {
               _loc3_ += serializeSingleImageData(_loc12_,param2[_loc12_]);
            }
            _loc3_ += "</item>";
         }
         return _loc3_;
