package anifire.component
{
   ...
   public class SkinnedCharacterMaker extends SkinnedAssetMaker
   {
      ...
      public function init(param1:XML, param2:ByteArray, param3:UtilHashArray, param4:UtilHashArray = null, param5:Boolean = false, param6:Boolean = false, param7:String = "", param8:String = "default") : void
      {
         ...
         (_loc9_ = CcActionLoader.getActionLoader(param7)).addEventListener(Event.COMPLETE,this.onCcActionLoaded);
         _loc9_.loadCcComponents(param1,0,0,param3,param4,ver,param6,param7,param8);
      }
