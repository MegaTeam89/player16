package anifire.playerEffect
{
   ...
   public class ZoomEffectAsset extends ProgramEffectAsset
   {
      ...
      public function init(param1:XML, param2:AnimeScene, param3:DisplayObjectContainer, param4:Number = 0) : void
      {
         ...
         var _loc15_:String;
         if((_loc15_ = _loc5_.@isCut) == "true")
         {
            this.cut = true;
         }
         var _loc16_:String;
         if((_loc16_ = _loc5_.@isPan) == "true")
         {
            this.pan = true;
         }
      ...
      private function calculateMotionData() : void
      {
         ...
         var _loc7_:uint = this.startFrame;
         while(_loc7_ <= this.endFrame)
         {
            _loc1_ = (_loc7_ - this.startFrame) / (this.endFrame - this.startFrame);
            _loc2_ = (_loc7_ - 1 - this.startFrame) / (this.endFrame - this.startFrame);
            if(_loc1_ < 0)
            {
               _loc1_ = 0;
            }
            ...
            _loc3_ = _loc8_ = this.originalPos.x + (this.targetPos.x - this.originalPos.x) * _loc1_;
            _loc4_ = _loc8_ = this.originalPos.y + (this.targetPos.y - this.originalPos.y) * _loc1_;
            _loc5_ = _loc8_ = this.originalScale.x + (this.targetScale.x - this.originalScale.x) * _loc1_;
            _loc6_ = _loc8_ = this.originalScale.y + (this.targetScale.y - this.originalScale.y) * _loc1_;
      ...
      override public function play(param1:Number) : void
      {
         ...
         {
            this.effectee.x = this._motionData[param1 - this.startFrame].x;
            this.effectee.y = this._motionData[param1 - this.startFrame].y;
            this.effectee.scaleX = this._motionData[param1 - this.startFrame].scaleX;
            this.effectee.scaleY = this._motionData[param1 - this.startFrame].scaleY;
            this._active = true;
         }
         if(this._mver > 3)
         {
