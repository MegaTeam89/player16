   ...
   public class Tweener
   {
      ...
      public static function addTween(param1:Object = null, param2:Object = null) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            (_loc17_ = new TweenListObj(_loc4_[_loc5_],_currentTime + _loc11_ * 1000 / _timeScale,_currentTime + (_loc11_ * 1000 + _loc10_ * 1000) / _timeScale,_loc9_.useFrames == true,_loc15_)).properties = _loc16_;
      ...
      public static function addCaller(param1:Object = null, param2:Object = null) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            (_loc11_ = new TweenListObj(_loc4_[_loc5_],_currentTime + _loc9_ * 1000 / _timeScale,_currentTime + (_loc9_ * 1000 + _loc8_ * 1000) / _timeScale,_loc7_.useFrames == true,_loc10_)).properties = null;
      ...
      public static function resumeTweenByIndex(param1:Number) : Boolean
      {
         ...
         _loc2_.timeStart += _currentTime - _loc2_.timePaused;
         _loc2_.timeComplete += _currentTime - _loc2_.timePaused;
      ...
      public static function debug_getList() : String
      {
         ...
         while(_loc2_ < _tweenList.length)
         {
            ...
            {
               _loc1_ += "  " + _tweenList[_loc2_].properties[_loc3_].name + " -> " + _tweenList[_loc2_].properties[_loc3_].valueComplete + "\n";
               _loc3_++;
            }
            _loc2_++;
         }
